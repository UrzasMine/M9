...
Zudem kann die Phasengeschwindigkeit auch graphisch bestimmt werden. Mit Hilfe von Gleichung \ref{} ergibt sich für die Steigung $m$
\begin{equation}
m = \frac{c}{2L}~{.}
\end{equation}
...
Wie Gleichung \ref{Phasengeschwindigkeit} erwarten lässt, steigt die Phasengeschwindigkeit mit höherer Spannkraft. Trägt man diese Werte in ein Grafik auf, so erhält man Abbildung \ref{inding}. 
