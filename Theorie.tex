...
Die Phasengeschwindigkeit einer Welle lässt sich durch, 
\begin{equation}
    \centering
    c = \frac{\lambda}{f} = \frac{\omega}{k} \text{mit} \left|k\right| = \frac{2\pi}{\lambda}
    \label{lambdaf}
\end{equation}
berechnen, wobei $\lambda$ die Wellenlänge der Welle beschreibt, $f$ die Frequenz der Welle, $k$ den Wellenvektor und $\omega$ die Kreisfrequenz. 